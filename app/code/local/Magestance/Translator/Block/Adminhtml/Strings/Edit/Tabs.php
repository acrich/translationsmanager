...
class Magestance_Translator_Block_Adminhtml_Strings_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
  ...
  protected function _beforeToHtml()
  {
      ...
      $this->addTab('item_paths', array(
      		...
      		'content'   => $this->getLayout()->createBlock('translator/adminhtml_strings_edit_tab_paths')->toHtml(),
      ));
